...
const Donars = () => {
  ...
  return (
    <div className="font-mono">
      ...
      <h1 className="text-2xl font-semibold text-center mt-60 text-primary">
        Our Blood Donars
      </h1>
      ...
      <div className="mx-auto mt-20 grid w-10/12 grid-cols-1 md:grid-cols-3 gap-10 mb-20">
        <h1 className="md:text-[100px] text-4xl absolute left-1/3 bottom-8 -z-10 text-[#F7F7F7] text-center font-mono font-bold">
          Blood Donars
        </h1>
