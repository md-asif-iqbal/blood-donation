    ...
    <div className="font-mono">
      <div className="mt-52">
        <h1 className="text-3xl text-center font-bold mb-2 text-white">
          Emergency <span className="text-primary"> Blood </span> Request!
        </h1>
        <p className="text-xl text-center font-bold text-white">
          Donate Blood & Save a Life, All types of blood are needed to help
          patients
        </p>
        <div className="w-full flex justify-center mt-6">
          <button className="donateBtn">
            <label htmlFor="my-modal-3" className=" uppercase cursor-pointer">
              Post a Request{" "}
            </label>
          </button>
