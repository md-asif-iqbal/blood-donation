  ...
  return (
    <div className="relative overflow-hidden">
      <div className="font-mono mt-28 ">
        ...
        <h1 className="md:text-[100px] text-4xl absolute left-1/4 top-32 -z-10 text-[#F7F7F7] text-center font-mono font-bold">
          Latest Donars
        </h1>
      </div>
      <div>
        ...
        <div className="flex justify-center mt-16">
          <a
            href="#_"
            class="relative inline-flex items-center justify-center px-10 py-4 overflow-hidden font-mono font-medium tracking-tighter text-white bg-primary rounded-lg group"
          >
            ...
            <span class="relative">
              <Link to="/donars">See All Donors</Link>
            </span>
          </a>
        </div>
      </div>
