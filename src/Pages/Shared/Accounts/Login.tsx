          ...
          <div className="signin-signup">
            <form className="sign-in-form" onSubmit={handleSubmit(onSubmit)}>
              ...
              <p className="text-lg text-secondary">
                {" "}
                Forgot Password?{" "}
                <button className="text-[#722ab5e4]" onClick={resetPassword}>
                  {" "}
                  Please Reset
                </button>{" "}
              </p>
              ...
              <input
                type="submit"
                value="Login"
                className="BtnPurple hover:text-black mt-4"
              />
              <div className="divider divide-purple-600 text-[#722ab5e4] w-7/12 mx-auto -mb-14">
                Or
              </div>
            </form>
            <SocialLogin />
        ...
        <div className="panels-container">
          <div className="panel left-panel">
            <div className="font-mono content">
              <img
                className="w-9/12 -mt-10 md:block hidden"
                src={SignUpImg}
                alt=""
              />
          ...
          <div className="panel right-panel font-mono">
            <div className="content">
              ...
              <h1 className="text-white text-md mb-4 -mt-20">
                All Ready Have an Account ?
              </h1>
              <button
                className="btn transparent text-gray-900"
                id="sign-in-btn"
