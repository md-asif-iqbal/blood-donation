      ...
      <div className="w-10/12 mx-auto mt-0 mb-20 font-mono">
        <div className="z-10">
          <div className="md:w-11/12 w-full mx-auto md:mb-[-80px] mb-[-120px] relative">
            <div>
              <img
                src="https://demos.creative-tim.com/soft-ui-dashboard-pro/assets/img/curved-images/curved0.jpg"
                className="rounded-xl mx-auto mt-10 h-40 md:h-full"
                alt=""
              />
            </div>
          </div>
          <div className="Profile-bg rounded-lg relative shadow-lg overflow-hidden w-9/12 md:w-8/12 mx-auto py-10 pl-10 mb-5">
            <div className="grid md:grid-cols-2 grid-cols-1 justify-between items-center">
              <div className="flex items-center flex-wrap">
                ...
                />
                <div>
                  <h1 className="md:ml-10 ml-0 mt-2 text-white text-xl font-semibold">
                    {user?.displayName}
                  </h1>
              ...
              <div className="mr-10 w-48 md:ml-auto ml-0 mt-5 md:mt-0">
                ...
                >
                  <h1 className="flex items-center full text-white py-2 px-3 border-white border-2">
        ...
        <div className="bg-white shadow-xl py-4 pl-10 rounded-xl">
          <div className="flex flex-wrap md:flex-nowrap items-center justify-between">
            <div>
              <p className="text-base font-medium leading-6 pb-5 text-secondary">
                {formattedDate} at{" "}
              ...
              <p className="text-secondary text-sm my-2 w-8/12">
                {userData?.describe}
              </p>
            </div>
            <div className="flex gap-2 pr-12">
              <h1 className="bg-primary p-4 text-primary bg-opacity-5 text-2xl rounded-lg">
                <FaFacebookSquare />
              </h1>
              <h1 className="bg-primary p-4 text-primary bg-opacity-5 text-2xl rounded-lg">
                <FaTwitterSquare />
          ...
          <div className="flex flex-wrap items-center justify-between">
            <div>
              ...
              <h1 className="text-lg my-2 gap-2 flex items-center text-secondary">
                {" "}
                <AiOutlineMail />
                {user?.email}{" "}
              </h1>
              ...
              <h1 className="text-lg my-2 gap-2 flex items-center text-secondary">
                {" "}
                <AiOutlineHome /> {userData?.district}
              </h1>
            ...
            <div className="mr-10">
              ...
              <h1 className="text-lg my-2 gap-2 flex items-center text-secondary">
                {" "}
                <FaUserGraduate /> {userData?.education}
              </h1>
              <h1 className="text-xl text-secondary mt-2">Blood Group -</h1>
              <h1 className="text-lg my-2 gap-2 flex items-center text-secondary">
                {" "}
                <MdBloodtype /> {userData?.bloodGrp}
              </h1>
            </div>
          </div>
        </div>
